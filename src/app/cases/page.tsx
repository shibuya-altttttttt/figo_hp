...
export const metadata: Metadata = {
  title: '成約実績',
  description:
    '株式会社Figo(新橋)の成約実績。東京・埼玉を中心とした一棟マンション・一棟ビル・区分マンションの仲介・買取実績をご紹介します。世田谷区・府中市・八王子市・戸田市などの取扱物件を含む第1期(2025年度)実績7件を掲載。',
  alternates: { canonical: '/cases' },
  openGraph: {
    title: '成約実績 | 株式会社Figo(新橋)',
    description:
      '東京・埼玉を中心とした一棟マンション・一棟ビル・区分マンションの仲介・買取実績(第1期2025年度)。',
    url: '/cases',
  },
};
