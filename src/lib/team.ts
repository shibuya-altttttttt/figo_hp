...
export const team: TeamMember[] = [
  {
    ...
    careerSummary:
      '2020年、同志社大学を卒業。同年、株式会社コスモスイニシアに入社し、不動産ソリューション事業にて法人向け投資用不動産の開発・仲介・運営に従事。2025年、株式会社Figoを創業。',
    career: [
      { period: '2020年', body: '同志社大学 卒業' },
      { period: '2020年', body: '株式会社コスモスイニシア 入社（不動産ソリューション事業）' },
  ...
  },
  {
    ...
    careerSummary:
      '2020年、北海道大学を卒業。同年、株式会社コスモスイニシアに入社し、不動産ソリューション事業にて法人向け投資用不動産の開発・運用に従事。2022年、株式会社リクルートに入社しSUUMOの広告営業および新規事業部を経験。2025年、株式会社Figoを共同創業。',
    career: [
      { period: '2020年', body: '北海道大学 卒業' },
      { period: '2020年', body: '株式会社コスモスイニシア 入社（不動産ソリューション事業）' },
      { period: '2022年', body: '株式会社リクルート 入社（SUUMO広告営業・新規事業部）' },
      { period: '2025年', body: '株式会社Figoを創業' },
    ],
  },
];
